...
const options = {
  contentType: ["コマなし漫画", "一枚漫画", "余白漫画", "漫画1コマ", "漫画3コマ", "縦スクロール漫画の1シーン", "リアルポートレート", "三面図", "三面図キャラカード", "キャラクターカード", "ステータスカード", "立ち絵素材", "雑誌表紙", "雑誌特集ページ", "note見出し画像", "SNSカルーセル1枚目", "キャラクター紹介ページ"],
  purpose: ["note記事の見出し画像", "SNS告知", "プロフィール画像", "漫画の導入", "キャラクター紹介", "キャラクター設定資料", "世界観紹介", "連載告知", "作品アーカイブ"],
  format: ["縦長 4:5", "正方形 1:1", "横長 16:9", "縦長 9:16", "A4縦", "A4横", "雑誌見開き風"],
  mangaCut: ["コマ割りなしの一枚漫画", "余白で読ませる漫画カット", "セリフなしの情景カット", "導入の引きカット", "表情アップ", "手元のディテールカット", "後ろ姿の余韻カット", "会話前の沈黙カット", "場面転換カット", "決めゴマ", "小さなオチのカット"],
  magazineLayout: ["コマなし漫画ページ", "余白のある漫画扉ページ", "静かな漫画誌面", "余白のある特集扉ページ", "静かなインタビューページ", "写真集の1ページ", "自然光のポートレートページ", "見出しが大きい雑誌表紙", "小さなキャプション入りページ", "図鑑風の紹介ページ", "キャラクターカード風", "ステータスカード風", "三面図の設定資料風", "コラム挿絵ページ"],
  composition: ["コマ枠なしで一枚絵として見せる", "人物と余白だけで構成する", "人物を右寄せ、左に余白", "中央に人物、周囲に大きな余白", "下部に人物、上部に見出し余白", "正面、横、背面を横並びに配置する", "人物とステータス欄を左右に分ける", "斜め構図", "画面端に小さく人物", "手元を大きく写す"],
  camera: ["顔アップ", "バストアップ", "腰上までの中距離", "全身", "三面図の全身", "引き構図", "俯瞰", "低い視点"],
  subject: ["静かな表情のキャラクター", "小さな相棒キャラクター", "雨の日の案内役", "研究室のキャラクター", "自然な表情の人物", "少し眠そうな人物", "余白の似合うキャラクター"],
  scene: ["雨上がりの路地", "白い部屋", "自然光の室内", "夜の駅", "古い図書室", "静かな研究室", "夕方の屋上", "余白のある誌面背景"],
  action: ["振り返っている", "本を持っている", "歩き出す直前", "窓の外を見ている", "小さく手を振っている", "座って考えている"],
  item: ["小さな本、街灯、濡れた床", "マグカップ、紙片、ペン", "見出し用の余白、細い罫線", "小さなアイコン、キャプション枠", "名前欄、属性欄、短い説明欄", "正面、横、背面のラベル", "植物、椅子、柔らかい光"],
  textArea: ["上部に短い見出し用の余白", "左側に縦書きコピー用の余白", "下部にキャプション用の余白", "文字なしで使える構図", "雑誌タイトルを置ける広い余白", "名前と短い設定文を置ける余白", "ステータス項目を置ける余白"],
  tone: ["静かで余韻のある雰囲気", "やわらかく読みやすい雰囲気", "自然光の静かな空気", "少し不思議な空気", "落ち着いた編集感", "透明感のある静けさ", "あたたかいけれど控えめ"],
  style: ["日本語ミニマル編集デザイン", "静かな漫画誌面", "写真集風", "リアルポートレート写真風", "雑誌特集ページ風", "余白のあるnoteサムネ風", "キャラクター設定資料風", "落ち着いたステータスカード風", "落ち着いたSNSカルーセル風"],
...
const presets = {
  ...
  "三面図": {
    ...
    format: "A4横",
    mangaCut: "セリフなしの情景カット",
    magazineLayout: "三面図の設定資料風",
    composition: "正面、横、背面を横並びに配置する",
    camera: "三面図の全身",
    subject: "余白の似合うキャラクター",
    scene: "白い部屋",
    action: "立っている",
  ...
  "キャラカード": {
    contentType: "キャラクターカード",
    purpose: "キャラクター紹介",
    format: "縦長 4:5",
    mangaCut: "表情アップ",
    magazineLayout: "キャラクターカード風",
    composition: "人物とステータス欄を左右に分ける",
    camera: "全身",
    subject: "静かな表情のキャラクター",
    scene: "余白のある誌面背景",
    action: "振り返っている",
    item: "名前欄、属性欄、短い説明欄",
    textArea: "名前と短い設定文を置ける余白",
    tone: "あたたかいけれど控えめ",
    style: "日本語ミニマル編集デザイン",
    avoid: "読みにくい小文字、情報過多"
  },
  "ステータスカード": {
    contentType: "ステータスカード",
    purpose: "キャラクター設定資料",
    format: "正方形 1:1",
    mangaCut: "決めゴマ",
    magazineLayout: "ステータスカード風",
    composition: "人物とステータス欄を左右に分ける",
    camera: "全身",
    subject: "研究室のキャラクター",
    scene: "余白のある誌面背景",
    action: "本を持っている",
    item: "名前欄、属性欄、短い説明欄",
    textArea: "ステータス項目を置ける余白",
    tone: "落ち着いた編集感",
    style: "落ち着いたステータスカード風",
    avoid: "文字の詰め込み、派手な演出"
  },
  "リアルポートレート": {
    contentType: "リアルポートレート",
    purpose: "プロフィール画像",
    format: "縦長 4:5",
    mangaCut: "表情アップ",
    magazineLayout: "自然光のポートレートページ",
    composition: "人物と余白だけで構成する",
    camera: "バストアップ",
    subject: "自然な表情の人物",
    scene: "自然光の室内",
    action: "窓の外を見ている",
