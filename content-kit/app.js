...
const options = {
  contentType: ["コマなし漫画", "一枚漫画", "余白漫画", "漫画1コマ", "漫画3コマ", "縦スクロール漫画の1シーン", "三面図", "三面図キャラカード", "キャラクターカード", "ステータスカード", "立ち絵素材", "雑誌表紙", "雑誌特集ページ", "note見出し画像", "SNSカルーセル1枚目", "キャラクター紹介ページ"],
  purpose: ["note記事の見出し画像", "SNS告知", "漫画の導入", "キャラクター紹介", "キャラクター設定資料", "世界観紹介", "連載告知", "作品アーカイブ"],
  ...
  magazineLayout: ["コマなし漫画ページ", "余白のある漫画扉ページ", "静かな漫画誌面", "余白のある特集扉ページ", "静かなインタビューページ", "写真集の1ページ", "見出しが大きい雑誌表紙", "小さなキャプション入りページ", "図鑑風の紹介ページ", "キャラクターカード風", "ステータスカード風", "三面図の設定資料風", "コラム挿絵ページ"],
  ...
  style: ["日本語ミニマル編集デザイン", "静かな漫画誌面", "写真集風", "雑誌特集ページ風", "余白のあるnoteサムネ風", "キャラクター設定資料風", "落ち着いたステータスカード風", "落ち着いたSNSカルーセル風"],
