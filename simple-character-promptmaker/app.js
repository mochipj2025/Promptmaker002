...
const options = {
  ...
  outputMode: ["一枚絵として出力", "立ち絵素材として出力", "リアルポートレートとして出力", "三面図として出力", "三面図キャラカードとして出力", "キャラクターカードとして出力", "ステータスカードとして出力", "SNS用アイコン素材として出力"],
  ...
  species: ["人間", "エルフ", "獣人", "妖精", "精霊", "魔法使い", "アンドロイド", "ドール", "吸血鬼", "小さな相棒種族"],
  skinTone: ["明るい肌", "自然な肌色", "健康的な肌色", "あたたかみのある肌", "褐色の肌", "日焼けした肌", "白い肌", "透明感のある肌", "青白い肌", "淡い灰色の肌"],
  ...
  mood: ["静かな雨の夜", "やわらかい朝", "自然光の静かな空気", "少し不思議な空気", "ひんやりした空気", "あたたかい夕暮れ", "透明感のある静けさ"],
